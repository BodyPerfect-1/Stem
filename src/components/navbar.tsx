  ...
  return (
    <div className="bg-white">
          ...
          >
            ...
            <div className="border-t border-gray-200 px-4 py-6">
              <a href="#" className="-m-2 flex items-center p-2">
                ...
                />
                <span className="ml-3 block text-base font-medium text-gray-900">DHA Approved</span>
              </a>
            </div>
          </DialogPanel>
        </div>
      ...
      <header className="relative bg-white">
        ...
        $100 Worth You Get free BMI And Advanced AI Body Scaning
        </p>

        <nav aria-label="Top" className="mx-auto max-w-full sm:px-2 lg:px-2">
          <div className="border-b border-gray-200">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 hover:text-gray-800">
                    <img
                      ...
                      className="block h-auto w-5 shrink-0"
                    />
                    <span className="ml-3 block text-sm font-medium">DHA Approved</span>
                  </a>
                </div>
